...
class NewsListingService {
  ...
  static Future<TopHeadlineNewsModel> getCategoryNews(String category) async {
    return await ApiManager(url: NewsAppUrls.newsHeadlines+"category=$category&"+apiKey).get((p0) {
      return TopHeadlineNewsModel.fromJson(p0);
    });
  }
