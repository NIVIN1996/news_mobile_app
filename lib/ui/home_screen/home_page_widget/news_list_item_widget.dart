...
class NewsListItemWidget extends StatefulWidget {
  ...
  const NewsListItemWidget({Key? key, required this.index, }) : super(key: key);
...
class _NewsListItemWidgetState extends State<NewsListItemWidget> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Card(
        elevation: 5,shadowColor: AppColor.lightBlue,
                        ...
                        children: [
                          ...
                          GestureDetector(onTap: (){
                            setState((){
                              ...
                              child: Icon(selectBookmark ? Icons.bookmark : Icons.bookmark_outline,color: AppColor.yellow2, size:context.widthPx * 18)),
                        ],
                      ),
                    ),
                    Text(
