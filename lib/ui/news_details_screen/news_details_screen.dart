          ...
          children: [
                      ...
                      GestureDetector(
                          ...
                          child: Padding(
                            ...
                            child: Icon(Icons.share,
                                color: AppColor.grey5, size: context.widthPx * 30),
                          )),
                      GestureDetector(
                          onTap: () {
                            setState(() {
                ...
                children: [
                  Expanded(
                    ...
                    child: Text(
                      ...
                      style: TextFontStyle.med(color: AppColor.black, size: context.textPx * 25),
                    ),
                  ),
            ...
            Padding(
              ...
              child: Text(
                ...
                style: TextFontStyle.regular(color: AppColor.black, size: context.textPx * 18),
              ),
            ),
          ],
        ),
